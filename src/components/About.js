...
function About({ aboutText, menu, aboutImgSrc }) {
  return (
    <div id="wrapper">
      <Header links={menu} />
      <main className="clear m1 mt4 pt4 clearfix">
        <img src='https://images.unsplash.com/photo-1459128806329-1b61d19a0f93?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&w=800&h=400&fit=crop&s=d7eb9a7a335cbd55db5ecd2db7bf1afd' className="mb1 mlrauto six-x displayBlock"/>
